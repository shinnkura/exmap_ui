    ...
    <DashboardLayout>
      <div className="space-y-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-3xl font-bold tracking-tight">企業マッチング設定</h2>
            <p className="text-muted-foreground">企業マッチングシステムの詳細設定</p>
          </div>
        </div>
          <p className="text-muted-foreground">企業マッチングシステムの詳細設定</p>
        </div>
          ...
          <CardContent>
            <Tabs defaultValue="data" className="space-y-4">
              ...
              <TabsContent value="data">
                <DataEditor type="company" />
              </TabsContent>

              <TabsContent value="search">
                <SearchConditionEditor type="company" />
              </TabsContent>

              <TabsContent value="display">
                <ResultDisplayEditor type="company" />
              </TabsContent>

              <TabsContent value="export">
                <CsvExportEditor type="company" />
              </TabsContent>
            </Tabs>
          </CardContent>
        </Card>
